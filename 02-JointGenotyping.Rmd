...
This chapter explains how to jointly genotype all isolates (the 3,034 plus eventual additional isolates), in order to generate a multisample VCF for the whole population. 
